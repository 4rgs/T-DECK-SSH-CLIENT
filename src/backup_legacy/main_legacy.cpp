//==============================================================================
// ⚠️  DEPRECATED - LEGACY MONOLITHIC VERSION
//==============================================================================
//
// Este archivo contiene la versión monolítica original del T-Deck SSH Terminal
// 
// 🚫 ESTADO: DEPRECATED - No se debe usar para nuevos desarrollos
// 📅 FECHA DE DEPRECACIÓN: 27 Septiembre 2025
// 🔄 REEMPLAZADO POR: Arquitectura modular en src/main.cpp
//
// 📋 RAZONES DE DEPRECACIÓN:
// - Código monolítico difícil de mantener (1500+ líneas)
// - Alto acoplamiento entre componentes
// - Difícil testing y debugging
// - Limitada escalabilidad
// - Desarrollo en equipo complicado
//
// 🏗️ NUEVA ARQUITECTURA:
// El proyecto ahora usa una arquitectura modular con los siguientes módulos:
// - HardwareManager: Gestión de hardware T-Deck
// - WiFiManager: Gestión de redes y conectividad
// - SSHManager: Conexiones SSH y descubrimiento de hosts
// - PersistenceManager: Almacenamiento persistente
// - UIManager: Interfaz de usuario y renderizado
// - CommandProcessor: Procesamiento de comandos
//
// 📖 DOCUMENTACIÓN:
// Ver MODULAR_ARCHITECTURE.md para detalles completos
//
// ⚡ PARA USAR ESTA VERSIÓN (no recomendado):
// 1. Renombrar este archivo como main.cpp
// 2. Mover src/main.cpp a otro lugar
// 3. Actualizar platformio.ini para remover filtros modulares
//
//==============================================================================
